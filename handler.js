...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'owner aja yg boleh menggunakan fitur ini',
    owner: 'owner bot aja yg boleh memakai fitur tersebut',
    mods: 'kalo kamu moderator kyura bot,baru boleh memakai fitur ini',
    premium: 'khusus member premium kak, maaf.',
    group: 'eitss..fitur ini bolehnya dipake di grup, bukan japri',
    private: 'hmm..maaf, fitur itu hanya boleh di chat pribadi bot',
    admin: 'hanya admin yang boleh memakai fitur tersebut',
    botAdmin: 'jadikan bot sebagai admin,kalau ingin menggunakan fitur ini',
